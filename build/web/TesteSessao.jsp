...
<html>
    ...
    <body>
        ...
        %> <p> <% out.print(sessao.getAttribute("idUsuarioLogado")); %> </p> 
        <p> <% out.print(sessao.getAttribute("nomeUsuarioLogado")); %> </p>
        <p> <% out.print(sessao.getAttribute("classeUsuarioLogado")); %> </p>
